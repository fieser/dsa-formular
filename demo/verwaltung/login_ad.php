...
<div class='flex-container'>
	<div class='flex-item-left'>
		...
		<input style="width: 23.3em; margin-bottom: 0.4em;" class='btn btn-default btn-sm' type="submit" name="cmd[doStandardAuthentication]" value="Download der Skriptvorlagen"  />
		<i>(Stand 30.04.2024)</i>
		</form>
