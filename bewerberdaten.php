...
if (isset($_POST['nachname'])) {
	...
	if (substr($_SESSION['strasse'],-4) == " Str") {
		$_SESSION['strasse'] = str_replace(" Str"," Straße",$_SESSION['strasse']);
	}
	
	if (substr($_SESSION['strasse'],-5) == " Str.") {
		$_SESSION['strasse'] = str_replace(" Str."," Straße",$_SESSION['strasse']);
	}
	
	if (substr($_SESSION['strasse'],-3) == "str") {
		$_SESSION['strasse'] = str_replace("str","straße",$_SESSION['strasse']);
	}
	...
	if ($strasse_pruefen == 1) {
	
	$_SESSION['strasse'] = checkAndCorrectStreet($_SESSION['strasse'], $_SESSION['plz']);
	
	//echo "<pre>";
//print_r ( checkAndCorrectStreet($_SESSION['strasse'], $_SESSION['plz']) );
////echo "</pre>";
	}
...
<div class="flex-container">
	...
	<div class="flex-item-left">
        ...
        <input style='width:100%;' type="text" id="vorname" name="vorname" value='<?php echo $_SESSION["vorname"] ?>' required pattern="[A-ZÖÄÜ].*"><br>
	</div>
		
	<div class="flex-item-right">
			<label for="nachname">Nachname:</label><br>
			<input style='width:100%;' type="text" id="nachname" name="nachname" value='<?php echo $_SESSION["nachname"] ?>' required pattern="[A-ZvedÖÄÜ].*"><br>
	</div>
</div>
